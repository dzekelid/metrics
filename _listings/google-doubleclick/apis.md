...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/metrics/master/_listings/google-doubleclick/apis.md
...
- name: Google Doubleclick Merged API - Get Metrics
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/metrics/master/_listings/google-doubleclick/accountsaccountidmetadatametrics-get-openapi.md
- name: Google Doubleclick Merged API - Get Metrics
  x-api-slug: accountsaccountidmetadatametrics-get
  description: List the metadata for the metrics available to this AdExchange account.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/google-double-click.png
