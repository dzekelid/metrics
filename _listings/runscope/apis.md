...
- name: Runscope
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/metrics/master/_listings/runscope/buckets-bucketkey-tests-testid-metrics-get.md
- name: Runscope Get Buckets Tests Metrics
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/metrics/master/_listings/runscope/buckets-bucketkey-tests-testid-metrics-get-postman.md
x-common:
- type: x-base-url
